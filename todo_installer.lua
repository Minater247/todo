...
elseif option == "2" then
    ...
    if fs.exists("/todo/.version") and con then
        ...
        if ninstver > instver then
            ...
            if inp == "y" then
                download("https://raw.githubusercontent.com/Minater247/todo/master/todo_installer.lua", "/vim/installer")
            ...
            if nvimver > vimver then
                ...
                download("https://raw.githubusercontent.com/Minater247/CCVim/master/vim.lua", "/vim/vim.lua")
                download("https://raw.githubusercontent.com/Minater247/CCVim/master/lib/args.lua", "/vim/lib/args.lua")
                download("https://raw.githubusercontent.com/Minater247/CCVim/master/lib/fil.lua", "/vim/lib/fil.lua")
                download("https://raw.githubusercontent.com/Minater247/CCVim/master/lib/str.lua", "/vim/lib/str.lua")
                download("https://raw.githubusercontent.com/Minater247/CCVim/master/lib/tab.lua", "/vim/lib/tab.lua")
